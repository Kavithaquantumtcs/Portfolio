      ...
      <header className="fixed bg-base-300 shadow-2xl shadow-neutral inset-x-0 top-0 z-50">
        ...
        >
          <div className="flex lg:flex-1">
            <p className="-m-1.5 p-1.5 font-semibold">Kavitha's Portfolio</p>
          </div>
            ...
            <div className="grid justify-center items-center mt-3">
              ...
              <div className="text-center">
                ...
                <p className="mt-6 text-2xl leading-8">
                  <TypeAnimation
                    sequence={[
                      ...
                      2000,
                      "I'm a Manual Test Engineer",
                      2000,
                      "I'm a Mobile Test Engineer",
                      2000,
                    ]}
                    speed={50}
                    repeat={Infinity}
                ...
                <div className="mt-10 flex items-center justify-center gap-x-6">
                  <p>
                  Enthusiastic Automation Tester has experience in quality assurance and automated testing. Experienced in using tools like Selenium and JMeter to enhance testing processes and ensure software reliability. Proficient in Java and JavaScript, with a solid grasp of various testing frameworks. Dedicated to delivering high-quality software through effective automation and teamwork.
                  </p>
                </div>
